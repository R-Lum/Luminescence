...
Cobbles and rocks are increasingly being used in luminescence dating applications. This function calculates the dose rate profile through the cobble based on the attenuation coeffecients presented by Riedesel and Autzen (2020). This function uses the new function `convert_Concentration2DoseRate()` to convert provided U, Th and K concentrations into dose rates. The function then corrects the beta dose rate in the cobble for the grain size following results of Guerin et al. (2012). Sediment beta and gamma dose rates are corrected for the water content of the sediment using the correction factors of Aitken (1985). Water content in the cobble is assumed to be 0. An example data set is provided.
