...
author: "Sebastian Kreutzer, Geography & Earth Sciences, Aberysthwyth University (United Kingdom)"
...
The column `RC.Status` informs you about a failed rejection criterion, which one is not revealed, 
but the column provides a possibility for further sub setting. For a quick data processing this is, 
...
If you want to combine the two tables for a more virtuous data processing, you can merge both tables
by calling:
