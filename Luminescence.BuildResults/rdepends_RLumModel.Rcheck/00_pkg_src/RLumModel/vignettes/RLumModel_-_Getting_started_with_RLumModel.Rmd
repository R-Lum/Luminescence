...
author: "Johannes Friedrich (University of Bayreuth, DE) & Sebastian Kreutzer (Earth Sciences and Geography, Abersytwyth University, UK)"
date: '`r Sys.Date()`'
output: 
...
this can be achieved with the following code lines:
