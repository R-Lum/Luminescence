...
### Aliases: ExampleData.BINfileData
### Keywords: datasets
...
base::assign(".dptime", (proc.time() - get(".ptime", pos = "CheckExEnv")), pos = "CheckExEnv")
base::cat("calc_EED_Model", base::get(".format_ptime", pos = 'CheckExEnv')(get(".dptime", pos = "CheckExEnv")), "\n", file=base::get(".ExTimings", pos = 'CheckExEnv'), append=TRUE, sep="\t")
cleanEx()
...
##D 
##D ##load example data
##D data(ExampleData.XSYG, envir = environment())
##D 
##D ##subtract background
##D TL.Spectrum@data <- TL.Spectrum@data[] - TL.Spectrum@data[,15]
##D 
##D ##replace 0 values
...
###   as.data.frame.RLum.Data.Spectrum as.list.RLum.Results
###   as.list.RLum.Data.Curve as.list.RLum.Analysis
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: read_BIN2R
### Title: Import Ris<c3><b8> BIN/BINX-files into R
### Aliases: read_BIN2R
### Keywords: IO
...
base::assign(".ptime", proc.time(), pos = "CheckExEnv")
### Name: write_R2BIN
### Title: Export Risoe.BINfileData into Ris<c3><b8> BIN/BINX-file
### Aliases: write_R2BIN
### Keywords: IO
...
## Not run: 
##D 
##D ##load exampled dataset
##D data(ExampleData.BINfileData, envir = environment())
##D 
##D ##create temporary filepath
##D ##(for usage replace by own path)
##D temp_file <- temp_file <- tempfile(pattern = "output", fileext = ".bin")
##D 
##D ##export to temporary file path
##D write_R2BIN(CWOSL.SAR.Data, file = temp_file)
##D 
## End(Not run)
