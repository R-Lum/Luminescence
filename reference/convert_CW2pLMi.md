...
a pseudo linearly modulated (pLM) curve under linear modulation
...
estimation routine for `P`, i.e. provide no own value for `P`.
...
manually and more than two points are extrapolated, a warning message is
returned.
