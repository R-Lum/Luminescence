...
sTeve<- function(n_frames = 10, t_animation = 2, n.tree = 7, type) {
  ...
  if(type == 1) {    
    ...
    for(i in 1:n) {
      ...
      ## branch one
      filledellipse(rx1 = 10 * tree.size[i], 
                    rx2 = 0.00001, 
      ...
      ## branch two
      filledellipse(rx1 = 8 * tree.size[i], 
                    rx2 = 0.00001, 
      ...
      ## branch three
      filledellipse(rx1 = 6 * tree.size[i], 
                    rx2 = 0.00001, 
      ...
      ## branch four
      filledellipse(rx1 = 4 * tree.size[i], 
                    rx2 = 0.00001, 
      ...
      ## sphere one
      filledellipse(rx1 = 1 * f * tree.size[i], 
                    ry1 = 1 * tree.size[i], 
                    mid = c(tree.x[i] + 2 * tree.size[i], 
                            tree.y[i] + 5 * tree.size[i]), 
                    col = shadepalette(n = 20, endcol = "darkred"))
      
      ## sphere two
      filledellipse(rx1 = 0.8 * f * tree.size[i], 
                    ry1 = 0.8 * tree.size[i], 
                    mid = c(tree.x[i] - 1 * tree.size[i], 
                            tree.y[i] + -3 * tree.size[i]), 
                    col = shadepalette(n = 20, endcol = "orange"))
      
      ## sphere three
      filledellipse(rx1 = 1.2 * f * tree.size[i], 
                    ry1 = 1.2 * tree.size[i], 
                    mid = c(tree.x[i] - 1.7 * tree.size[i], 
                            tree.y[i] + 2 * tree.size[i]), 
                    col = shadepalette(n = 20, endcol = "yellow3"))
      ...
      filledellipse(rx1 = 1 * f * tree.size[i], 
                    ...
                    col = shadepalette(n = 20, endcol = "darkblue"))
