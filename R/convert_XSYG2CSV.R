...
#'
#' @param file [character] (\bold{required}): name of the XSYG-file to be converted to CSV-files
#'
#' @param \dots further arguments that will be passed to the function [read_XSYG2R] and [write_RLum2CSV]
#'
...
#' \code{\link[utils]{write.table}}, [write_RLum2CSV], [read_XSYG2R]
#'
#' @keywords IO
#'
#' @examples
