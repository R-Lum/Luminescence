...
#' 
#' @description Add crosstalk, evenly spread in rook (top-right-bottom-left) directions, to all 
#' grain whole locations on one measurement discs (=on position on a measurement wheel in a reader). An 
...
#'
#' @return Numerical value, a bit smaller than 0: the expected Moran's I for the null hypothesis 
#' (= no spatial correlation), according to -1/(n-1) with n the number of used observations.
#'
#'
#' @author Anna-Maartje de Boer, Luc Steinbuch, Wageningen University & Research, 2025
#'
...
#' 
#' @details See also https://geodacenter.github.io/workbook/5a_global_auto/lab5a.html#permutation-inference
#'
#' @author Anna-Maartje de Boer, Luc Steinbuch, Wageningen University & Research, 2025
#'
#' @examples
