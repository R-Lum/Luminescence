...
#' mixed fission track ages. Nuclear Tracks Radiation Measurements 4, 459-470. \cr\cr 
#' 
...
#' models.  Archaeometry 41, 339-364. \cr\cr 
#' 
...
#' of optical dating of fluvial deposits.  Quaternary Geochronology, 1 109-120. \cr\cr 
#' 
