...
#' and directly exports its content to CSV-files.  If nothing is set for the argument \code{path} ([write_RLum2CSV])
...
#' \code{\link[utils]{write.table}}, [write_RLum2CSV], [read_Daybreak2R]
#'
#' @keywords IO
#'
#' @examples
