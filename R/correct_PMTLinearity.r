...
#'
#'@description Correct linearity of PMT counts to avoid saturation effects, depending
#'on pulse-pair-resolution of individual PMTs.
#'
#'@details We correct for count linearity using a well-known formula that
#'can be found for example in the Hamamatsu Photomultiplier handbook
...
#'
#'@param object [RLum.Analysis-class] [RLum.Data.Curve-class] (**required**): object with records to corrected
#'
...
#'
#'@returns Returns the same type of object type as `object`
#'
#'@references
#'
...
#'
#'@note This function is an adaptation of core from the R package
#''OSLdecomposition'
#'
#'
#'@examples
