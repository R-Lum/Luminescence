...
# Return object -------------------------------------------------------------------------------
   ...
   ##note<<
   ## The information for the slot 'protocol' is taken from the first \code{\linkS4class{RLum.Analysis}} 
   ## object in the input list. Therefore at least one object of type \code{\linkS4class{RLum.Analysis}} 
   ## has to be provided.
   
   ##seealso<<
   ## \code{\link{merge_RLum}}, \code{\linkS4class{RLum.Analysis}}, 
   ## \code{\linkS4class{RLum.Data.Curve}}, \code{\linkS4class{RLum.Data.Spectrum}},
