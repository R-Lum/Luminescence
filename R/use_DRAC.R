...
#' ## text <- paste("DRAC-example Quartz Q AdamiecAitken1998 3.4000 0.5100 14.4700 ",
...
#' ## X <- use_DRAC(file = text)
#'
#'  ##file = "~/Desktop/DRAC_Input_and_Output_Template-2.xlsx"
#'  ##send example data set let DRAC do the calculations
#'  ##use_DRAC(file = file)
#'
#' @export use_DRAC
use_DRAC <- function(
  ...
  DRAC.response <- httr::POST(paste("https://www.aber.ac.uk/en/iges/",
