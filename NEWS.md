...
# Changes in version 0.9.24.9000-20 (2024-02-16)
...
- If the input was created via `read_XSYG2R()` the function checks the
  chronological order of the input data and re-orders the data with a
  warning if needed.
