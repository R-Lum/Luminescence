...
# Changes in version 1.1.1.9000-2 (2025-11-25)
...
- The visualisation of the ‘Checks’ (former rejection criteria) was not
  ...
  inequality symbols, such as `<=` or `>=` instead of `<>` (which as
  meant to be understood as a comparator). Furthermore, the recycling
  ratio now better shows the set limit depending on whether the ratio is
