...
# Changes in version 1.0.1.9000-16 (2025-04-08)
...
- The graphical `...` argument `contour` never produced a meaningful
  contour plot due to an internal error (#686). Along, a new argument
  `contour_nlevels` is now supported through `...` to better control the
