...
# Changes in version 1.1.2.9000-33 (2026-01-09)
...
- The function struggled with variable header lengths; fixed (#1262,
  thanks for reporting to @andrzejbluszcz )

- The function will no any longer crash if the data point entries have
  more than four columns (thanks to @andrzejbluszcz for reporting).
