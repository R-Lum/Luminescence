...
# Changes in version 1.2.1.9000-5 (2026-07-21)
...
- Extend the argument `predict` to handle backwards and forward
  prediction.
...
- The function broke with
  `Error in histogram$counts : object of type 'closure' is not subsettable`
  if the fit could not be established and the object `histogram` was
  exposed in the namespace by another package; fixed.
