...
# Changes in version 0.9.25.9000-90 (2024-11-12)
...
- If `fit.method = "EXP+LIN"`, the function got sometimes stuck in an
...
- Two new internal functions `.throw_warning()` and `.throw_error()`,
  added in v0.9.25, in particular circumstances flushed very long
  traceback messages to the terminal instead of reporting the name of
  the calling function. Now we maintain an internal stack of function
