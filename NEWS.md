...
# Changes in version 1.2.1.9000-6 (2026-07-07)
...
- Furthermore, the output object data frame was expanded to support new
  ...
  available. Please note that the new output table was also updated in
  `analyse_SAR.CWOSL()` and subsequent functions.
