...
# Changes in version 1.3.0.9000-2 (2026-08-31)
...
- The handling of `mtext` has been improved so that, when speccified as
  a list, each element is dispatched (with recycling) to each object
  being plotted, making `mtext` behave like the `main` argument (#1676).
