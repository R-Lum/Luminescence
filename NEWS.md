...
- `apply_Crosstalk()`, `calc_MoransI()`, `calc_MoransI_pseudo_p()`,
  `plot_SingleGrainDisc()` and `plot_MoranScatterplot()` were
  contributed by Anna-Maartje de Boer and Luc Steinbuch (#560).
