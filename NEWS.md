...
# Changes in version 1.0.1.9000-19 (2025-04-16)
...
- The fundamental physical constants used in the package (such as
  ...
  fit_CWCurve(), fit_LMCurve(), fit_SurfaceExposure(),
  fit_ThermalQuenching() (#693).
...
- Blank gaps appearing to the sides of the proportion of components plot
  for hight number of components have been removed (#713).
