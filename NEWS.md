...
# Changes in version 1.1.2.9000-38 (2026-02-27)
...
- When the input data is an `RLum.Results` object generated by
  `calc_CentralDose()`, `calc_MaxDose()`, `calc_MinDose()` or
  `calc_FiniteMixture()`, one or more lines (and corresponding labels)
  for the relevant results will be automatically drawn, unless
  explicitly suppressed by setting `line = NA` (#1452).
