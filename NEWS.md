...
# Changes in version 1.0.1.9000-69 (2025-06-03)
...
- The residual plot for `method = "FIT"` correctly respects the
  logarithmic transformation of the x-axis, if the user specified
  `log = "x"` (#814).
...
- If in `mode = "alternate“`, no error about the equivalent dose that
  could not be fitted is shown anymore.
