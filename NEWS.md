...
# Changes in version 1.1.2.9000-36 (2026-01-23)
...
- The function reports a clearer error message if
  `background.integral.min` is not greater than `signal.integral.max`,
  and improved warnings in other cases when the integrals are set
  incorrectly (#1267).
