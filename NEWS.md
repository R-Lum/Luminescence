...
- Function `calc_OSLLxTxRatio()` adds two new columns to the output
  `SN_RATIO_LnLx` and `SN_RATIO_TnTx`. This may potentially disrupt code
  that relies on the column index instead of the name (#1281).
