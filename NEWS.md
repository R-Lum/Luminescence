...
# Changes in version 1.1.2.9000-19 (2025-12-19)

## New functions

- `normalise_RLum()`: This function enables a fast normalisation of
  `RLum.Data.Curve-class`, `RLum.Data.Spectrum-class` and its
  combination of `RLum.Analysis-class` objects. Normalisation was
