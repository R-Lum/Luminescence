...
// analyse_IRSARRF_SRS
RcppExport SEXP analyse_IRSARRF_SRS(IntegerVector values_regenerated_limited, IntegerVector values_natural_limited, IntegerVector vslide_range, int n_MC);
RcppExport SEXP Luminescence_analyse_IRSARRF_SRS(SEXP values_regenerated_limitedSEXP, SEXP values_natural_limitedSEXP, SEXP vslide_rangeSEXP, SEXP n_MCSEXP) {
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(analyse_IRSARRF_SRS(values_regenerated_limited, values_natural_limited, vslide_range, n_MC));
